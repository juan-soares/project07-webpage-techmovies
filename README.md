# 📌 WEB PAGE: TECH MOVIES (HTML, CSS, JS)
...
Projeto para prática de desenvolvimento web Front-end, utilizando HTML, CSS e JavaScript. Consiste em uma Web Page das áreas do desenvolvimento web representadas em filmes fictícios. Contém um carrossel, que altera dinamicamente a imagem e as informações do conteúdo principal, conforme o usuário avança ou retrocede nos botões de seleção.
